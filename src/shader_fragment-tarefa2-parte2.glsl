...
void main()
{
    ...
    vec4 light_position = vec4(0.0,2.0,1.0,1.0); // Posição da Luz
    float alpha = cos(3.14159265/6); // Ângulo de Abertura da Câmera
    // Calcula ângulo entre o ponto e a câmera
    float beta = dot(normalize(p - light_position), -l);
